...
bool apakahAlokasiValid(Shift jadwal[], Dokter* dokter, int idx);
...
void preferensiMenu(UserPreferences *prefs, Dokter daftar_dokter[], int *jumlah_dokter, Shift jadwal[], int *jadwal_dibuat);
